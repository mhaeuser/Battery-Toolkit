...
internal final class BTCommandsMenuDelegate: NSObject, NSMenuDelegate {
    ...
    @IBOutlet private var infoChargingToThresholdItem: NSMenuItem!
    ...
    @IBOutlet private var infoRequestedChargingToThresholdItem: NSMenuItem!
    ...
    @IBOutlet private var chargeToThresholdNowItem: NSMenuItem!
    @IBOutlet private var disableChargingItem: NSMenuItem!

    @IBOutlet private var requestChargingToFullItem: NSMenuItem!
    @IBOutlet private var requestChargingToThresholdItem: NSMenuItem!
    ...
    private func refresh() async {
        do {
            ...
            if !chargingDisabled {
                ...
                self.infoRequestedChargingToThresholdItem.isHidden = true
                ...
                case Int(BTStateInfo.ChargingMode.standard.rawValue),
                    Int(BTStateInfo.ChargingMode.toThreshold.rawValue):
                    self.infoChargingToFullItem.isHidden = true
                    self.infoChargingUnknownModeItem.isHidden = true
                    self.infoChargingToThresholdItem.isHidden = false
                    
                case Int(BTStateInfo.ChargingMode.toFull.rawValue):
                    self.infoChargingToThresholdItem.isHidden = true
                    self.infoChargingUnknownModeItem.isHidden = true
                ...
                self.chargeToThresholdNowItem.isHidden = true
                ...
                case Int(BTStateInfo.ChargingMode.toThreshold.rawValue):
                    self.infoNotChargingItem.isHidden = true
                    self.infoRequestedChargingToFullItem.isHidden = true
                    self.infoNotChargingUnknownModeItem.isHidden = true
                    self.infoRequestedChargingToThresholdItem.isHidden = false
            ...
            if connected {
                ...
                self.requestChargingToThresholdItem.isHidden = true
                ...
                case Int(BTStateInfo.ChargingMode.standard.rawValue):
                    ...
                    self.requestChargingToThresholdItem
    ...
    @IBAction private func chargeToThresholdHandler(sender _: NSMenuItem) {
        Task {
            do {
                try await BTActions.chargeToThreshold()
            } catch {
                BTErrorHandler.errorHandler(error: error)
            }
        }
